...
# -------------------------------------------------------------
echo "Installing requirements..." && apt-get install -y build-essential cmake libssl-dev libpcre2-dev bison libreadline-dev zlib1g-dev libpcre3-dev libncurses5-dev libncursesw5-dev libaio-dev libcurl4-openssl-dev pkg-config git sudo wget curl zip unzip jq rsync >/dev/null 2>&1
